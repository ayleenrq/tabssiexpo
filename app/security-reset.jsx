    ...
    const onKeyPress = (val) => {
        if (val === 'del') {
            ...
            if (next.length === 6) {
                setTimeout(() => {
                    onClose();
                    router.push('/security-new-password');
                }, 300);
            }
        }
    };
            ...
            <View style={m.overlay}>
                <View style={m.sheet}>
                    ...
                    <Text style={m.sub}>
                        ...
                        <Text style={{ color: '#8B5CF6' }}>{email}</Text>
                    </Text>
                    ...
                    <TouchableOpacity>
                        <Text style={m.resend}>
                            Didn't receive a code? <Text style={{ color: Colors.textGray }}>Resend (01:12)</Text>
                        </Text>
                    </TouchableOpacity>
...
export default function SecurityResetPasswordScreen() {
    ...
    return (
        <SafeAreaView style={s.safe}>
            ...
            <OtpBottomSheet visible={showOtp} email={email || "Helloali@gmail.com"} onClose={() => setShowOtp(false)} />
        </SafeAreaView>
    );
}
...
const s = StyleSheet.create({
    ...
    input: {
        backgroundColor: '#E5E7EB', // Gray background for the input on step 1 based on image
