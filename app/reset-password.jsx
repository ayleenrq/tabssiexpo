    ...
    return (
        <SafeAreaView style={s.safe}>
            ...
            <ScrollView contentContainerStyle={s.container} keyboardShouldPersistTaps="handled">
                ...
                <View style={[s.inputWrapper, confirmError && s.inputError]}>
                    <TextInput
                        style={s.inputInner}
                ...
                <Requirement met={hasLowercase} text="1 lowercase letter (a-z)" />
...
const s = StyleSheet.create({
    ...
    container: { paddingHorizontal: Spacing.xxl, paddingTop: Spacing.xxl, paddingBottom: 40 },
    ...
    reqTitle: { color: Colors.textGray, fontSize: 13, marginBottom: 12 },
